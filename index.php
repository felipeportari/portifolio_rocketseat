...
<body> <?php include 'config.php' ?> <section style="min-height: 80vh">
    <div class="container">
      <div style="display: flex; flex-direction: column; gap: 15px">
        ...
        <div class="technologies"> <?php foreach ($technologies as $technology): ?> <div class="technology" style="width:fit-content;background-color:<?= $technology['color'] ?>50;padding:5px 10px; border-radius:50px;border:1.5px solid <?= $technology['color'] ?>70 "><?= $technology['name'] ?></div> <?php endforeach; ?> </div>
      </div>
